...
public class ModFoodComponents {
    ...
    public static final FoodComponent POWER_CORE = new FoodComponent.Builder().nutrition(3).saturationModifier(0.3f)
            .statusEffect(new StatusEffectInstance(StatusEffects.POISON, 50, 2), 0.3f)
            .statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 80, 2), 0.8f)
            .statusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 40), 0.3f)
            .statusEffect(new StatusEffectInstance(StatusEffects.BLINDNESS, 70), 0.3f)
            .statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 30), 0.3f)
            .statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 1), 0.8f)
            .alwaysEdible()
            .build();
